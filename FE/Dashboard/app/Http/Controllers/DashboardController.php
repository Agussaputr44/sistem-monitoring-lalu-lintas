    ...
    public function resetData(Request $request)
{
    try {
        ...
        $deletedCount = DB::table('vehicle_detections')->count();

        // Kosongkan tabel
        DB::table('vehicle_detections')->truncate();

        // Logging
        Log::info('Vehicle detection data reset', [
        ...
        return response()->json([
            'success'       => true,
            'message'       => 'Semua data kendaraan berhasil dihapus',
            'deleted_count' => $deletedCount
        ]);

    } catch (\Exception $e) {
        Log::error('Error resetting vehicle data: '.$e->getMessage());
