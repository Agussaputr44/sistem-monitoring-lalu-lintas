    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center py-3">
                    ...
                    <div class="text-muted">
                        ...
                        Live Data | Last Update: <span id="lastUpdate">{{ now()->format('H:i:s') }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card">
                    <div class="card-body">
                        ...
                        <h2 id="todayCount">{{ $totalToday }}</h2>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="stat-card warning">
                    <div class="card-body">
                        ...
                        <h2 id="monthCount">{{ $totalMonth }}</h2>
                        <p class="mb-0">Total Kendaraan</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="{{ route('dashboard.history') }}" class="btn btn-primary btn-lg me-3">
